...
- **Daily Grind:** Solving CTFs on TryHackMe & HackTheBox.
- **Current Study:** Deep diving into Active Directory Exploitation (Kerberos, NTLM) and Web App Pentesting (Burp Suite).
- **Goal:** Landing a role as a Junior Pentester or SOC Tier-1 Analyst.
